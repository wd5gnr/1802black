...
image (e.g. rommerge, romcksum, etc) are copyright (C) 2004-2006 by Spare Time
...
rcasm assembler, are not included in this distribution and you will need to
obtain those components from his web site before you can rebuild the Elf
2000 EPROM.
