...
; ***          Bit 6 - 1861 video ?                   ***
; ***          Bit 7 - 9118 video ?                   ***
; ***          Bit 8 - extended BIOS vectors at $F800 ***
; ***          Bit 9 - extended BIOS vectors at $F000 ***
; *******************************************************

; Device bits returned in RF.0
...
; BIOS options bits returned in RF.1
BIOSOPTS:  equ  01h     ; extended vectors at $F800

getdev:    ldi     DEVICES+UARTDEV+NVRDEV  ; load map of supported devices
           plo     rf                  ; ...
           ldi     BIOSOPTS            ; high byte is BIOS options
           phi     rf                  ; ...
           sep     sret                ; return
#endif
